...
uploaded_img = st.file_uploader('Upload Your X-Ray Here, type=None, accept_multiple_files=False, key=None, help=None, on_change=None, args=None, kwargs=None, *, disabled=False)
