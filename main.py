...
if button1:
    ...
    st.write("Probably you have not detected it, but this person has a dangerous pneumonia, highlighted on the second picture above. You can compare both, a helty lung and one with pneumonia by clicking these radio buttons:")
